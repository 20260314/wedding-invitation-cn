...
export const WEDDING_DATE_FORMAT = `YYYY年 M月 D日 星期六 上午h点${WEDDING_DATE.minute() === 0 ? "" : " m분"}`
...
export const WEDDING_HALL_POSITION = [127.194809, 36.998491]

// 네이버 지도의 웨딩홀 장소 ID
// 네이버 지도 웹페이지에서 웨딩홀 검색 후 URL에서 확인 가능.
// 예: https://map.naver.com/p/entry/place/13321741 -> 13321741
export const NMAP_PLACE_ID = 19083380
